    ...
    <div className="service-page">
        ...
        <div className="container">
          <div className="service-hero-inner">
            <div className="service-hero-text">
              ...
              <p>From SEO to paid ads and social media — we build and execute digital marketing strategies that drive real traffic, real leads, and real revenue.</p>
              <Link href="/contact" className="service-hero-cta">Get a Free Strategy Call <i className="bi bi-arrow-right"></i></Link>
            </div>
            <div className="service-hero-image">
              <NextImage src="/assets/img/service-hero.jpg" alt="Digital Marketing Services" width={420} height={320}
      ...
      <section className="service-process">
        <div className="container">
          <div className="text-center mb-5">
            ...
            <p className="section-sub mx-auto">A structured approach that turns your marketing budget into measurable growth.</p>
          </div>
      ...
      <section className="service-cta">
        <div className="container">
          ...
          <Link href="/contact" className="service-cta-btn">Book a Free Call <i className="bi bi-arrow-right"></i></Link>
        </div>
      </section>
    </div>
  );
